...
public class VoteHistoryAdapter extends RecyclerView.Adapter<VoteHistoryAdapter.VoteHistoryViewHolder> {

    private final List<VoteHistoryResponse> votes;

    public VoteHistoryAdapter(List<VoteHistoryResponse> votes) {
        this.votes = votes;
    }

    @NonNull
    @Override
    public VoteHistoryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_vote_history, parent, false);
        return new VoteHistoryViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull VoteHistoryViewHolder holder, int position) {
        VoteHistoryResponse vote = votes.get(position);
        holder.bind(vote);
    }
    ...
    static class VoteHistoryViewHolder extends RecyclerView.ViewHolder {
        ...
        public VoteHistoryViewHolder(@NonNull View itemView) {
            super(itemView);
        ...
        public void bind(VoteHistoryResponse vote) {
            ...
            // Определяем выбранный вариант (0 или 1 для SelectedOption)
            String voteText = vote.getVoteText();
            tvYourChoice.setText("Ваш выбор: " + (voteText != null ? voteText : "Неизвестно"));
            ...
            if (vote.isClosed()) {
                ...
                if (vote.getWinningOption() != null) {
                    // WinningOption: 1 = первый вариант, 2 = второй вариант
                ...
                tvVotingActive.setText("Голосование активно");
            }
